  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg space-y-6 mb-12">
      <h2 className="text-xl font-semibold text-center text-gray-700">
        Please choose the initial coordinates and direction for your robot.
      </h2>

      <div className="flex flex-col space-y-4">
        <div className="flex items-center justify-between">
          <label htmlFor="x-coordinate" className="text-lg text-gray-600">
            X Coordinate: {activeCoordinateX}
          </label>
          <input
            type="range"
            id="x-coordinate"
            ...
            max="5"
            className="w-32"
            value={activeCoordinateX}
            onChange={(e) => handleInputChange("x", e.target.value)}
          />
        </div>

        <div className="flex items-center justify-between">
          <label htmlFor="y-coordinate" className="text-lg text-gray-600">
            Y Coordinate: {activeCoordinateY}
          </label>
          <input
            type="range"
            id="y-coordinate"
            ...
            max="5"
            className="w-32"
            value={activeCoordinateY}
            onChange={(e) => handleInputChange("y", e.target.value)}
          />
        </div>

        <div className="flex items-center justify-between">
          <label htmlFor="direction" className="text-lg text-gray-600">
            Direction: {activeDirection}
          </label>
          <select
            name="direction"
            id="direction"
            className="w-32 py-2 px-3 bg-gray-100 rounded-md"
        ...
        {gameStart || (
          <Button onClick={() => startButtonClick(true)}>Start!</Button>
        )}
        ...
        {gameStart && (
          <>
            <div className="flex flex-col items-center">
              ...
              <span className="hidden md:block text-sm text-gray-500 mt-1">
...
GameSettings.propTypes = {
  ...
  moveButtonClick: PropTypes.func.isRequired,
  leftButtonClick: PropTypes.func.isRequired,
  rightButtonClick: PropTypes.func.isRequired,
  reportButtonClick: PropTypes.func.isRequired,
